-- conn delphix_db/"Jul#3thr"@"&dbname"
-- conn system/"Cloudy#1"@"&dbname"
-- conn system/"Plains#1"@"&dbname"
-- conn system/"Tundra#1"@"&dbname"
-- conn system/"Equipo#0"
conn system/"K1sm3t#9"@"&dbname"
--conn system/"Install#123"@"&dbname"
