...
col iowait_time_avg		heading 'Avg IO'			for 999,999
col clwait_time_avg		heading 'Cu Wait IO'		for 999,999
col apwait_time_avg		heading 'App Wait IO'		for 999,999
col ccwait_time_avg		heading 'Conc Wait IO'		for 999,999
col plsexec_time_avg	heading 'PLS Wait IO'		for 999,999
col javexec_time_avg	heading 'Java Wait IO'		for 999,999
...
Accept lsql_id 	char Prompt 'Enter Sqlid we want to check: '
...
select sql_id,  plan_hash_value,  executions_total,
	...
	trunc(decode(executions_total, 0, 0, iowait_total*power(10,-6)/executions_total)) 			iowait_time_avg,
	trunc(decode(executions_total, 0, 0, clwait_total*power(10,-6)/executions_total)) 			clwait_time_avg,
	trunc(decode(executions_total, 0, 0, apwait_total*power(10,-6)/executions_total)) 			apwait_time_avg,
	trunc(decode(executions_total, 0, 0, ccwait_total*power(10,-6)/executions_total)) 			ccwait_time_avg,
