...
col capture_user				heading 'Capture User'		format a20
...
/
set termout on
select '/Users/gsundaresan/Documents/Gan/Sql_spool/'||'&instance'||'gg_hist_log_info_'||to_char(sysdate,'yyyymmdd') spoolfile from dual
/
spool &spoolfile
