-- 	File 		:	MON_RMAN_DELPHIX.SQL
--	Description	:	Monitor RMAN Jobs Running from Delphix
...
/
set termout on
select 'C:\Ganesh\Work\SQL-SPOOL\'||'&instance'||'mon_rman_delphix_'||to_char(sysdate,'yyyymmdd') spoolfile from dual
/
spool &spoolfile
