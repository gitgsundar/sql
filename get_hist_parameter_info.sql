...
--	Description	:	Provides details of Historical Parameter Information.
...
select 'C:\Ganesh\Work\SQL-SPOOL\'||'&instance'||'get_hist_parameter_info'||to_char(sysdate,'yyyymmdd') spoolfile from dual
/
spool &spoolfile
...
where
		...
		and upper(p.parameter_name)  like UPPER('%&lparameter_name%')
)
select
