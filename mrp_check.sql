...
host comm.lst >> mrpcheck.txt


prompt Searching Product Tops, Please wait ...


host echo '' >> mrpcheck.txt
host echo '11. Product Tops :' >> mrpcheck.txt
host echo '==================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
host echo '' >> mrpcheck.txt
host echo '12. Form Versions :' >> mrpcheck.txt
host echo '===================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
spool comm.lst
  ...
  select 'strings -a $'||basepath||'/forms/'||userenv('LANG')||'/*.fmx | grep ''$Header: ''' 
  from   fnd_application
  where  application_id  in (704);
...
host echo '' >> mrpcheck.txt
host echo '13. Library Versions :' >> mrpcheck.txt
host echo '======================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt

spool comm.lst
   select distinct 'strings -a $AU_TOP/resource/'||substr(ff.form_name, 1, 3)||'*.plx | grep ''$Header: '''
   from fnd_form ff
   where application_id  in (704);
...
host echo '' >> mrpcheck.txt
host echo '14. Reports Versions :' >> mrpcheck.txt
host echo '======================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
spool comm.lst
  ...
  select 'strings -a $'||basepath||'/reports/'||userenv('LANG')||'/*.rdf | grep ''$Header: '''
  from   fnd_application
  where  application_id  in (704);
...
host echo '' >> mrpcheck.txt
host echo '15. ODF File Versions :' >> mrpcheck.txt
host echo '=======================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
spool comm.lst
   ...
   select 'strings -a $'||basepath||'/patch/115/odf/*.odf | grep ''$Header: ''' 
   from   fnd_application 
   where  application_id  in (704);
...
host echo '' >> mrpcheck.txt
host echo '16. WorkFlow File Versions :' >> mrpcheck.txt
host echo '============================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
spool comm.lst
   ...
   select 'strings -a $'||basepath||'/patch/115/import/*.wft | grep ''$Header: ''' 
   from   fnd_application 
   where  application_id  in (704);
...
prompt searching Pro*C file version, Please wait ...

host echo '' >> mrpcheck.txt
host echo '17. Product Pro*C Files :' >> mrpcheck.txt
host echo '=========================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
spool comm.lst
  ...
  select 'strings -a $'||basepath||'/lib/lib'||substr(lower(APPLICATION_SHORT_NAME),1,3)||'.a | grep -i ''$Header:'''
  from   fnd_application
  where  application_id  in (704);
...
host echo '' >> mrpcheck.txt
host echo '18. Contents of Listener.ora :' >> mrpcheck.txt
host echo '==============================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
host cat $ORACLE_HOME/network/admin/$TWO_TASK/listener.ora >> mrpcheck.txt

spool off


host chmod 777 comm.lst
host cat comm.lst >> mrpcheck.txt
host comm.lst >> mrpcheck.txt
...
host echo '19. Item Attribute Controls :' >> mrpcheck.txt
host echo '=============================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
prompt Show organization list ...

set head on
host echo '' >> mrpcheck.txt
host echo '20. Organization list :' >> mrpcheck.txt
host echo '=======================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
host echo '' >> mrpcheck.txt
host echo '21. System Items Segment list :' >> mrpcheck.txt
host echo '===============================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
host echo '' >> mrpcheck.txt
host echo '22. Stock Locators Segment list :' >> mrpcheck.txt
host echo '=================================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
host echo '' >> mrpcheck.txt
host echo '23. Language list :' >> mrpcheck.txt
host echo '===================' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
...
host echo '' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
host echo 'Plans' >> mrpcheck.txt
host echo '===============' >> mrpcheck.txt

spool comm.lst

  select COMPILE_DESIGNATOR, SCHEDULE_DESIGNATOR, ORGANIZATION_ID, DECODE(PLAN_TYPE,
       1,'MRP',
       2,'MPS',
       3,'DRP',
       4,'IP',
       to_char(PLAN_TYPE)) "Plan Type"
  from mrp_plans
...
host echo '' >> mrpcheck.txt
host echo 'Report completed at Date/Time' >> mrpcheck.txt
host date '+%d/%m/%y %H:%M:%S' >> mrpcheck.txt
host echo '' >> mrpcheck.txt
host echo 'End of Diagnostic Report' >> mrpcheck.txt
host echo '' >> mrpcheck.txt

prompt
prompt Application Diagnostic Report mrpcheck.txt is now available in user's Current Directory.
prompt
