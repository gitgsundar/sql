...
select '/Users/gsundaresan/Documents/Gan/Sql_spool/'||'&instance'||'mon_hist_dbwait_'||to_char(sysdate,'yyyymmdd_hhmiss') spoolfile from dual
/
spool &spoolfile
...
Accept levent char Prompt 'What Wait Events: '

tti off
tti Left 'Specific Wait Events :' skip 2

select event 
from v$system_event
where event like '%&levent%'
/

Accept levent_name char Prompt 'What Specific Wait Event you are looking for: '
tti off
tti Left 'Specific Wait Events Information :' skip 2
